...
def dcn_resnet18(pretrained=False, **kwargs):
...
def dcn_resnet34(pretrained=False, **kwargs):
...
def dcn_resnet50(pretrained=False, **kwargs):
...
def dcn_resnet101(pretrained=False, **kwargs):
