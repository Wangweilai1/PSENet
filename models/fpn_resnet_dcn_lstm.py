...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        if (planes != 512):
            ...
            self.conv2 = DCN(planes, planes, kernel_size=(3,3), stride=stride, padding=1, dilation=1, deformable_groups=1)
        self.bn2 = nn.BatchNorm2d(planes)
...
def resnet18_dcn_lstm(pretrained=False, **kwargs):
...
def resnet34_dcn_lstm(pretrained=False, **kwargs):
...
def resnet50_dcn_lstm(pretrained=False, **kwargs):
...
def resnet101_dcn_lstm(pretrained=False, **kwargs):
...
def resnet152_dcn_lstm(pretrained=False, **kwargs):
