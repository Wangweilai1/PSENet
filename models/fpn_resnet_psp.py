...
__all__ = ['ResNet', 'resnet18_psp', 'resnet34_psp', 'resnet50_psp', 'resnet101_psp',
           'resnet152_psp']
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=7, scale=1):
        ...
        self.head = PSPHead(1024, num_classes, norm_layer=nn.BatchNorm2d)
...
def resnet18_psp(pretrained=False, **kwargs):
...
def resnet34_psp(pretrained=False, **kwargs):
...
def resnet152_psp(pretrained=False, **kwargs):
