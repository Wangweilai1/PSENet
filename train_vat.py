...
def main(args):
    ...
    if args.arch == "resnet50":
        ...
        model = models.se_resnet_50(pretrained=False, num_classes=kernel_num)
    elif args.arch == "se_resnext_50":
        model = models.se_resnext_50(pretrained=False, num_classes=kernel_num)
    elif args.arch == "dcn_resnet50":
        model = models.dcn_resnet50(pretrained=True, num_classes=kernel_num)
